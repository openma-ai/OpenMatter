...
This is a directional profile specification. The executable v0 foundation does not yet claim Compiler/Profile conformance; its implemented contracts are documented in [Runtime Architecture](./RUNTIME_ARCHITECTURE.md).
